    ...
    <div className="connect-page">
      ...
      <main className="connect-content">
        <div className="connect-banner">
          <img src="/assets/web/brand-banner.jpg" alt="" />
        </div>

        <div className="connect-avatar">
          <img src="/assets/web/logo-mark.png" alt="The Ai Advantage Co." />
        </div>

        <h1 className="connect-title">
          THE A<span className="connect-i">i</span> ADVANTAGE
        </h1>
        <p className="connect-sub">Ai Coaching &amp; Implementation</p>
        ...
        <div className="connect-links">
          <a
            ...
            className="connect-btn connect-btn--yt"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="connect-btn connect-btn--ig"
          >
            <svg viewBox="0 0 24 24" fill="currentColor" width="24" height="24">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="connect-btn connect-btn--li"
          >
            <svg viewBox="0 0 24 24" fill="currentColor" width="24" height="24">
        ...
        <div className="connect-footer">
          <a href="https://www.theaiadvantageco.com.au" className="connect-site-link">
